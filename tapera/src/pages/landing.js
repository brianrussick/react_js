...
export default function Landing() {
    ...
    return (
        <div class="bg-white ...">
          ...
          <div class="absolute top-72 pt-60 lg:pt-0 right-8 w-full flex-1 lg:divide-y-0 mt-32 lg:mt-44 ml-72 pl-10 space-y-0.5 font-opensans lg:absolute lg:left-0 lg:top-10 ...">
          ...
          <div><p class="text-4xl mb-10 ...">Money like you’ve never had before</p></div>
            ...
            <img class="h-84 lg:absolute lg:left-20 lg:h-full lg:w-full ..." alt ='' id='phone' src={Phone} />
            </div>
            ...
            <div><p class="ml-2 text-2xl lg:text-2xl font-opensans lg:ml-24 ...">Algorand network will enable equal access to all,</p></div>
            ...
            <div><p class="text-lg lg:text-2xl text-black font-opensans text-left lg:text-center ...">first and foremost by processing small transactions at no cost to our users.</p></div>
