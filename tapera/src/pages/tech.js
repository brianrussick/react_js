export default function Tech() {
    ...
    <div class="p-4 bg-white rounded-lg">
         ...
         <div id="body" class="flex flex-col ml-5">
            <h4 id="name" class="text-5xl font-semibold  mb-10 lg:mb-2 font-heading text-red-500">Current Projects</h4>
            <div class=" bg-gray-100 lg:flex lg:items-center">
  
    <div class="lg:h-20 lg:ml-16 lg:flex lg:justify-center lg:items-center">
      <div class="space-y-3 lg:space-x-96 lg:space-y-0">
        ...
        <a href="#tba" class="py-3 px-8 lg:px-6 text-white text-2xl rounded-lg bg-purple-600 shadow-lg block md:inline-block">Soon to be Announced</a>
            ...
            Oracles keeping it running.</p>

            <h4 id="pipeline" class="text-5xl text-green-400 font-semibold mb-2 mt-9">Pipeline</h4>
            <h4 id="wallet" class="text-3xl font-semibold mb-2 mt-9">Hardware Wallet</h4>
            <p id="text" class="text-2xl text-gray-800 mt-9">We are developing a cheap and portable crypto wallet solution that will keep account
            information offline but easily accessible. We are developing it in tandem with a wallet application that will be web accessible and 
            increase both portability and security for Algorand transactions. Stay tuned for more developments!</p>

            <h4 id="tba" class="text-5xl text-purple-600 font-semibold mb-2 mt-9">Soon to be Announced</h4>
